...
<div align="center" class="addmu">
	<br><br><br>
	<div align="center" style="width:100%" class="addmu">
	
	<form action="addMu.do" method="post" onsubmit="return checkSubmit()"
	...
	<!-- <form action="addMu.do" method="post" enctype="multipart/form-data">		 -->	
			<table>
				...
				<tr>
					<td>회사 아이디</td>
					<td colspan="3">
						<input type="text" name="muDto.cid" id="_cid" size="60"><font id="_cidCheckFld"></font>
					</td>
				</tr>
				<tr>
					<td>회사명</td>
					<td colspan="3">
						<input type="text" name="muDto.cname" id="_cname" size="60" readonly>
					</td>
				</tr>
				<tr>
					<td>회사 주소</td>
					<td colspan="3">
						<input type="text" name="muDto.address" id="_address" size="60" readonly>
					</td>
				</tr>
				<tr>
					<td>상세내용</td>
					<td colspan="3">
						<textarea rows="5" cols="60" name="muDto.content" id="_content" ></textarea>
					</td>
				</tr>
				...
				<tr id="_pd0">
					...
					<td>
						<input type="text" name="muPdList[0].title" id="_muPdTitle0">
					</td>
					<td>가격</td>
					<td>
						<input type="text" name="muPdList[0].price" id="_muPdPrice0" onblur="checkNum(0)">
					</td>
				</tr>
				<tr>
